...
import { sendChatRequestTrace } from '@/lib/sendChatRequestTrace';
...
export default function Home() {
    ...
    const sendLlmRequest = async (e?: any) => {
        ...
        const response = await sendChatRequestTrace('Who is JFK?');
        console.log('response: ' + response)
        const responseObject = JSON.parse(response)
        setContent(responseObject.kwargs.content);
